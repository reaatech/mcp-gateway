...
import { type RedisClient, RedisRateLimitStore } from './redis-store.js';
import type {
  RateLimitConfig,
  RateLimitResult,
  RateLimitStore,
...
export class RateLimiter {
  ...
  async checkLimit(tenantId: string, config?: Partial<RateLimitConfig>): Promise<RateLimitResult> {
