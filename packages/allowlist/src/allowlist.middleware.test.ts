...
import { clearTenants, setTenant } from '@reaatech/mcp-gateway-core';
import type { NextFunction, Request, Response } from 'express';
import { beforeEach, describe, expect, it, vi } from 'vitest';
import { allowlistMiddleware } from './allowlist.middleware.js';
...
describe('allowlistMiddleware', () => {
  ...
  describe('extracts tool name from request body', () => {
    it('calls next when authContext is missing', async () => {
      ...
      await middleware(mockReq as unknown as Request, mockRes as Response, mockNext);
