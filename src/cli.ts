#!/usr/bin/env node
import { startCommand } from './cli/commands/start.command.js';
import { validateConfigCommand } from './cli/commands/validate-config.command.js';
import { healthCommand } from './cli/commands/health.command.js';
import { cacheStatsCommand } from './cli/commands/cache-stats.command.js';
import { listTenantsCommand } from './cli/commands/list-tenants.command.js';
import { listUpstreamsCommand } from './cli/commands/list-upstreams.command.js';
import { rateLimitStatusCommand } from './cli/commands/rate-limit-status.command.js';
