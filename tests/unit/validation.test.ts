...
describe('Schema Validation', () => {
  ...
  describe('validateJsonRpcRequest', () => {
    ...
    it('rejects wrong jsonrpc version', () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors.some(e => e.field === 'jsonrpc' || e.message.includes('jsonrpc'))).toBe(true);
    });
    ...
    it('rejects missing method field', () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors.some(e => e.field === 'method' || e.message.includes('method'))).toBe(true);
    });
